...
# How To Use:
- Ensure you are using at least the 0.2 version of Sprocket (The Current Release)
...
- You can add a custom loading screen by replacing the "SplashScreen.png" with you own image
